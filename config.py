...
class Config:
    ...
    AI_TAIL_MAX_BPS = os.getenv('AI_TAIL_MAX_BPS')  # The tail covers 2.5% - 5.0% of the price movement
    
    PROFILING = True
    
    @classmethod
    def validate(cls):
        required_fields = ['API_ID', 'API_HASH', 'TELEGRAM_PHONE', 'CHANNEL_NAME', 'TTL_SECONDS', 'AGG_INTERVAL_SEC', 'AI_TOP_N', 'AI_TAIL_BINS', 'AI_TAIL_MAX_BPS']
        missing_fields = []
